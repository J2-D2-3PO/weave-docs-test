...
## Prerequisites[​](/guides/evaluation/weave_local_scorers#prerequisites "Direct link to Prerequisites")
...
## Select a scorer[​](/guides/evaluation/weave_local_scorers#select-a-scorer "Direct link to Select a scorer")

The following local scorers are available. Select a scorer based on your use case.

| Scorer                                                                                                | Scenario                                                                                                                            |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [WeaveToxicityScorerV1](/guides/evaluation/weave_local_scorers#weavetoxicityscorerv1)                 | Identify toxic or harmful content in your AI system's inputs and outputs, including hate speech or threats.                         |
| [WeaveBiasScorerV1](/guides/evaluation/weave_local_scorers#weavebiasscorerv1)                         | Detect biased or stereotypical content in your AI system's inputs and outputs. Ideal for reducing harmful biases in generated text. |
| [WeaveHallucinationScorerV1](/guides/evaluation/weave_local_scorers#weavehallucinationscorerv1)       | Identify whether your RAG system generates hallucinations in its output based on the input and context provided.                    |
| [WeaveContextRelevanceScorerV1](/guides/evaluation/weave_local_scorers#weavecontextrelevancescorerv1) | Measure whether the AI system's output is relevant to the input and context provided.                                               |
| [WeaveCoherenceScorerV1](/guides/evaluation/weave_local_scorers#weavecoherencescorerv1)               | Evaluate the coherence and logical structure of the AI system's output.                                                             |
| [WeaveFluencyScorerV1](/guides/evaluation/weave_local_scorers#weavefluencyscorerv1)                   | Measure whether the AI system's output is fluent.                                                                                   |
| [WeaveTrustScorerV1](/guides/evaluation/weave_local_scorers#weavetrustscorerv1)                       | An aggregate scorer that leverages the toxicity, hallucination, context relevance, fluency, and coherence scorers.                  |
| [PresidioScorer](/guides/evaluation/weave_local_scorers#presidioscorer)                               | Detect Personally Identifiable Information (PII) in your AI system's inputs and outputs using the Presidio library from Microsoft.  |

## `WeaveBiasScorerV1`[​](/guides/evaluation/weave_local_scorers#weavebiasscorerv1 "Direct link to weavebiasscorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes "Direct link to Usage notes")
...
### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example "Direct link to Usage example")
...
## `WeaveToxicityScorerV1`[​](/guides/evaluation/weave_local_scorers#weavetoxicityscorerv1 "Direct link to weavetoxicityscorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-1 "Direct link to Usage notes")
...
### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-1 "Direct link to Usage example")
...
## `WeaveHallucinationScorerV1`[​](/guides/evaluation/weave_local_scorers#weavehallucinationscorerv1 "Direct link to weavehallucinationscorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-2 "Direct link to Usage notes")
...
### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-2 "Direct link to Usage example")
...
## `WeaveContextRelevanceScorerV1`[​](/guides/evaluation/weave_local_scorers#weavecontextrelevancescorerv1 "Direct link to weavecontextrelevancescorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-3 "Direct link to Usage notes")
...
### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-3 "Direct link to Usage example")
...
## `WeaveCoherenceScorerV1`[​](/guides/evaluation/weave_local_scorers#weavecoherencescorerv1 "Direct link to weavecoherencescorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-4 "Direct link to Usage notes")
...
### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-4 "Direct link to Usage example")
...
## `WeaveFluencyScorerV1`[​](/guides/evaluation/weave_local_scorers#weavefluencyscorerv1 "Direct link to weavefluencyscorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-5 "Direct link to Usage notes")

* The `score` method expects text to be passed to the `output` parameter.
* A higher output score indicates higher fluency.

### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-5 "Direct link to Usage example")

```
import weavefrom weave.scorers import WeaveFluencyScorerV1fluency_scorer = WeaveFluencyScorerV1()result = fluency_scorer.score(    output="The cat did stretching lazily into warmth of sunlight.")print(f"Output is fluent: {result.passed}")print(result)
```

***

## `WeaveTrustScorerV1`[​](/guides/evaluation/weave_local_scorers#weavetrustscorerv1 "Direct link to weavetrustscorerv1")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-6 "Direct link to Usage notes")

* This scorer is designed for evaluating RAG pipelines.
* It requires `query`, `context`, and `output` keys for correct scoring.

### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-6 "Direct link to Usage example")
...
## `PresidioScorer`[​](/guides/evaluation/weave_local_scorers#presidioscorer "Direct link to presidioscorer")
...
### Usage notes[​](/guides/evaluation/weave_local_scorers#usage-notes-7 "Direct link to Usage notes")
...
### Usage example[​](/guides/evaluation/weave_local_scorers#usage-example-7 "Direct link to Usage example")
...
To use Weave scorers in TypeScript, see [function-based scorers](/guides/evaluation/scorers#function-based-scorers).

[Edit this page](https://github.com/wandb/weave/blob/master/docs/docs/guides/evaluation/weave_local_scorers.md)
